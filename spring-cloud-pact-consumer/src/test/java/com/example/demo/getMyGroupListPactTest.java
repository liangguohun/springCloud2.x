...
public class getMyGroupListPactTest {
    ...
    public PactFragment createFragment(PactDslWithProvider pactDslWithProvider) {
        ...
        return pactDslWithProvider
                .given("200")//生产者对应的状态
                .uponReceiving("get user's groups")//对请求的描述
                    .path("/getMyGroupList")
                    .method("GET")
                    .headers(reqHeads)
                .willRespondWith()
                    .status(200)
                    .headers(headers)
                    .body("{\"rows\":[{\"id\":1,\"name\":\"Jack's Friends\",\"memberNum\":2}]}")
                .toFragment();
        //@formatter:on
    }
    ...
    public void runTest() throws Exception {
        ...
        new ConsumerClient(url).getAsMap("/getMyGroupList", reqHeads);
    }
