...
public class upPostPraisePactTest {
    ...
    public PactFragment createFragment(PactDslWithProvider pactDslWithProvider) {
        ...
        return pactDslWithProvider
                .given("200")//生产者对应的状态
                .uponReceiving("praise user's post")//对请求的描述
                    .path("/upPostPraise/1")
                    .method("GET")
                    .headers(reqHeads)
                .willRespondWith()
    ...
    public void runTest() throws Exception {
        ...
        new ConsumerClient(url).getAsMap("/upPostPraise/1", reqHeads);
    }
