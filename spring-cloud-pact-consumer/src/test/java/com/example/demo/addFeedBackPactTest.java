 ...
 */
public class addFeedBackPactTest {
    @Rule
    ...
    public PactFragment createFragment(PactDslWithProvider pactDslWithProvider) {
        ...
        return pactDslWithProvider
                .given("200")//生产者对应的状态
                .uponReceiving("create a new feedback")//对请求的描述
                    .path("/addFeedBack")
                    .method("POST")
                    .headers(reqHeads)
                    .body("{\"content\":\"very good\",\"star\":4.0}")
                .willRespondWith()
                    .status(200)
                    .headers(headers)
                .toFragment();
    ...
    public void runTest() throws Exception {
        ...
        new ConsumerClient(url).post("/addFeedBack",
        		"{\"content\":\"very good\",\"star\":4.0}"
