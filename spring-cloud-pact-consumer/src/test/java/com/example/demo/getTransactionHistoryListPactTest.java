...
public class getTransactionHistoryListPactTest {
    ...
    public PactFragment createFragment(PactDslWithProvider pactDslWithProvider) {
        ...
        return pactDslWithProvider
                .given("200")//生产者对应的状态
                .uponReceiving("Transaction History")//对请求的描述
                    .path("/getTransactionHistory/1/10")
                    .method("GET")
                    .headers(reqHeads)
                .willRespondWith()
                    .status(200)
                    .headers(headers)
                    .body("{\"pointsBalance\":\"102°\",\"rows\":[{\"id\":1,\"transactionName\":\"Receive after school\",\"dateTime\":\"Feb 28.2018\",\"points\":\"-12°\"}]}")
                .toFragment();
        //@formatter:on
    }
    ...
    public void runTest() throws Exception {
        ...
        new ConsumerClient(url).getAsMap("/getTransactionHistory/1/10", reqHeads);
    }
